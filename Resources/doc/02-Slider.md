...
{% block stylesheets %}
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('bundles/vincetbootstrapform/css/slider.css')}}">
{% endblock %}

{% block javascripts %}
    {{ parent() }}
    <script src="{{asset('bundles/vincetbootstrapform/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('bundles/vincetbootstrapform/js/bootstrap-slider.js')}}"></script>
